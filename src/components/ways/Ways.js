...
export default function FoodAccordionExample() {
  ...
  return<>
  <div className={styles.description}>לאנס הינו שירות רגיל אנו מספקות לכם חוויה , שונה ומיוחדת.
האירועים שלנו מתרחשים באווירה נעימה , מלאה באהבה , באוכל טוב , ביסים מדויקים עם תשומת לב לכל אחד .
כל אירוע אצלנו הוא מיוחד במינו אין שני לו .
ולכן אנחנו כאן כדי להפוך את היום שלכם להצלחה . 
בנוסף לתפריט המשלב בתוכו את המטבח הצרפתי הקלאסי לבין הים תיכוני , יצרנו עבורכם שולחן בופה מעוצב בסגנון ייחודי באווירה קסומה ורעננה. 
