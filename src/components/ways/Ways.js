...
export default function FoodAccordionExample() {
  ...
  return<>
  <div className={styles.description}>לאנס אינו שירות רגיל אנו מספקות לכם חוויה שונה ומיוחדת. <br/>
האירועים שלנו מתרחשים באווירה נעימה , מלאה באהבה , באוכל טוב , ביסים מדויקים עם תשומת לב לכל אחד . <br/>
כל אירוע אצלנו הוא מיוחד במינו אין שני לו . <br/>
ולכן אנחנו כאן כדי להפוך את היום שלכם להצלחה . <br/>
בנוסף לתפריט המשלב בתוכו את המטבח הצרפתי הקלאסי לבין הים תיכוני , יצרנו עבורכם שולחן בופה מעוצב בסגנון ייחודי באווירה קסומה ורעננה. <br/> 
בינתיים אתם מוזמנים לעיין וכשיגיע הרגע הנכון ביחד נבנה תפריט המתאים ביותר עבור האירוע שלכם .</div>
