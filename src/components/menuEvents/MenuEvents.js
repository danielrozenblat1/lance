    ...
    <div className={styles.gridContainer}>
      ...
      <div className={styles.container}>
        <div className={styles.section}>
          ...
          <MenuItem name="ברוסקטה" description="צרפתית - ריבת בצל<br />גבינת ברי<br />בולגרית - סלסת עגבניות<br />בלסמי חריף<br />שום<br />פטרוזיליה<br />מנצ'גו - פלפלים קלויים<br />גבינת מנצ'גו<br />מתוק - גבינת חלומי<br />קונפיטורת העונה<br />יותר מהראשונה - גבינה כחולה<br />אגס מקורמל" />
