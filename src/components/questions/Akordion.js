...
export default function BasicAccordion() {
  ...
  return <>
    ...
    <div className={styles.title} id="שאלות תשובות" itemProp="mainEntity" itemScope itemType="https://schema.org/WebPage">זמן לענות על השאלות שלכם</div>
      ...
      <DropdownAccordion title="אם אני רוצה להזמין שולחן בופה ל15 איש?" content="שירות  הקייטרינג שלנו עד בית הלקוח הוא למינימום הזמנה של 30 סועדים, איך יש אופציה לא פחות טובה של מגשי אירוח שתוכלו להזמין ולקבל משלוח עד אליכם :) ." />
