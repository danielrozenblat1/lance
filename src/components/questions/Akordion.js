...
export default function BasicAccordion() {
  ...
  return <>
    ...
    <div className={styles.title} id="שאלות ותשובות" itemProp="mainEntity" itemScope itemType="https://schema.org/WebPage">זמן לענות על השאלות שלכם</div>
      ...
      <DropdownAccordion title="האם העריכה ( צלחות + סכום) היא חדפ או רגילה?" content="אנו עובדות עם עריכות מתקלות מבמבוק , אך ניתן להוסיף להצעת מחיר השכרת ציוד בתיאום מראש ." />
    </div>
